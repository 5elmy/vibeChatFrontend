...
export default function ChatContainer() {
    ...
    if(isMessageLoading) return <div className='w-full flex flex-col overflow-auto'>
        <ChatHeader/>
        <MessageSkeleton/>
        <MessageInput/>
    </div>
                    ...
                    <div className='chat-image avatar'>
                        <div className='size-10 rounded-full border'>
                            <img  src={message.senderId ===authUser?._id ?
                                authUser?.profilePic || "/public/avatar.webp":
                                selectedUser?.profilePic || "/public/avatar.webp"
                            }
                            alt='profile pic'
                            />
                        </div>
