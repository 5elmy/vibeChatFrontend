...
export default function SettingPage() {
  ...
  return (
    <div className='min-h-screen container pb-10 mx-auto px-4 pt-20 max-w-5xl'>
              ...
              <div className='bg-base-100 rounded-xl shadow-sm overflow-hidden'>
                ...
                <div className='px-4 py-3 border-b border-base-300 bg-base-100'>
                  <div className='flex items-center gap-3'>
                    ...
                    <div>
                      <h3 className='font-medium text-sm'>Ahmed Helmy</h3>
                ...
                <div className='p-4 space-y-4 min-h-[220px] max-h-[200px] overflow-y-auto bg-base-100'>
